      ...
      <section className="bg-near-black py-[clamp(80px,10vw,140px)] px-8 lg:px-12">
        <div className="max-w-[1180px] mx-auto">
          ...
          <div className="mt-14 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            <Link
              href="/work-with-us"
              className="font-body text-[14px] tracking-[0.1em] uppercase text-near-black bg-gold px-9 py-4 hover:bg-gold-light hover:-translate-y-px transition-all duration-200 inline-block whitespace-nowrap"
            >
              Explore Engagements →
            </Link>
            <Link
